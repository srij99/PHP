            ...
            <table class=" table table-bordered  mt-5 " >
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-primary mx-2 w-25"><a class="text-light" href="edit_author.php?id=<?php echo$row['id'];?>" >Edit</a></button>
                        <button class="btn btn-danger mx-2 w-25"><a class="text-light" href="delete_author.php?id=<?php echo$row['id'];?>" >Delete</a></button></td>
