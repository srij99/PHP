...
<div class="row">
    ...
    <form action="" method="post" class="m-5 " autocomplete="off" >
        <div class="mb-3 text-center"> <h4> Add Category </h4> </div>
            ...
            <div class="form-group text-center ">
                <button type="submit" name="addcategory" class=" btn btn-primary  w-50 " >Add Category</button>
            </div>
...
if(isset($_POST['addcategory'])){
    ...
    $sql = "insert into category values(null,'$_POST[category_name]')";
