...
<div class="row">
    ...
    <form action="" method="post" class="m-5 " autocomplete="off" >
        <div class="mb-3 text-center"> <h4> Edit Category </h4> </div>
            <div class="form-group">
                <label for="name">Category Name:</label>
                <input type="text" name="cat_name" class="form-control mb-3" value="<?php echo $cat_name;?>" required>
            </div>
            
            
            <div class="form-group text-center ">
                <button type="submit" name="addauthor" class=" btn btn-primary  w-50 " >Edit Category</button>
            </div>
...
if(isset($_POST['addauthor'])){
    ...
    $sql2 = "update category set name='$_POST[cat_name]' where id=$_GET[id]";
