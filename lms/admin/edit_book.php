...
while ($ro = mysqli_fetch_assoc($res)) {
    $book_name = $ro['book_name'];
    $author_id=$ro['author_id'];
    $cat_id=$ro['cat_id'];
...
<div class="row">
    ...
    <form action="" method="post" class="m-5 " autocomplete="off" >
        <div class="mb-3 text-center"> <h4> Edit Book </h4> </div>
            <div class="form-group">
                <label for="name">Book Name:</label>
                <input type="text" name="book_name" class="form-control mb-3" value="<?php echo $book_name;?>" required>
            </div>
            <div class="form-group">
                <label for="id">Author ID:</label>
                <input type="number" name="author_id" class="form-control mb-3" value="<?php echo $author_id;?>" required>
            </div>
            <div class="form-group">
                <label for="id">Category ID:</label>
                <input type="number" name="category_id" class="form-control mb-3" value="<?php echo $cat_id;?>" required>
            </div>
            
            <div class="form-group text-center ">
                <button type="submit" name="addbook" class=" btn btn-primary  w-50 " >Edit Book</button>
            </div>
...
if(isset($_POST['addbook'])){
    ...
    $sql2 = "update books set book_name='$_POST[book_name]',author_id=$_POST[author_id],cat_id=$_POST[category_id] where book_id=$_GET[id]";
