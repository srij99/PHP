...
<div class="row">
    ...
    <form action="" method="post" class="m-5 " autocomplete="off" >
        <div class="mb-3 text-center"> <h4> Add Author </h4> </div>
            <div class="form-group">
                <label for="name">Author Name:</label>
                <input type="text" name="author_name" class="form-control mb-3" placeholder="Enter Author Name" required>
            </div>
    
            
            <div class="form-group text-center ">
                <button type="submit" name="addauthor" class=" btn btn-primary  w-50 " >Add Author</button>
            </div>
...
if(isset($_POST['addauthor'])){
    ...
    $sql = "insert into author values(null,'$_POST[author_name]')";
