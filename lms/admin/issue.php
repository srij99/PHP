...
<div class="row">
    ...
    <form action="" method="post" class="m-5 " autocomplete="off" >
        <div class="mb-3 text-center"> <h4> Issue Book </h4> </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="user_id" class="form-control mb-3" placeholder="Enter User ID" required>
            </div>
            <div class="form-group">
                <label for="id">Issue Date:</label>
                <input type="text" name="date" class="form-control mb-3" value="<?php echo date("yy-m-d");?>" required>
            </div>
            
            <div class="form-group text-center ">
                <button type="submit" name="issuebook" class=" btn btn-primary  w-50 " >Issue Book</button>
            </div>
...
if(isset($_POST['issuebook'])){
    ...
    $sql = "insert into issued values(null,'$_POST[book_name]',$_POST[user_id],1,'$_POST[date]')";
